...
Public Function OpenMultimedia(hWnd As Long, AliasName As String, _
    filename As String, typeDevice As String) As String
...
cmdToDo = "open " & ShortPathAndFile & " type " & typeDevice & _
    " Alias " & AliasName & " parent " & hWnd & " Style " & WS_CHILD
...
'note: don't think this handle to put movie on it, _
    this handle to get the size from it.
...
If Not LCase(CxOrCy) = "cx" And Not LCase(CxOrCy) = "cy" Then
    GetSize = -1
    Exit Function
End If
